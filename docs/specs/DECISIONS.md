...
| DEC-AUTH-INPUT                | 정규화 후 검증한다. `loginId`·`email`은 trim 후 소문자, `name`은 trim 후 최대 100자, `phone`은 공백·하이픈 제거 후 0으로 시작하는 9~11자리 숫자다. 비밀번호는 변환하지 않고 8~64자이면서 UTF-8 72byte 이하여야 하며 초과 입력을 절단하지 않는다.                    | AUTH-002, AUTH-003, AUTH-008, AUTH-009, AUTH-011, WORKPLACE-001, WORKPLACE-002 |
