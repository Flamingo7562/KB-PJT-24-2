 ...
 *
 * <p>{@code workplaceAddress}는 이미 합쳐진 문자열을 받습니다. API_SPEC 4.0.0은 결합 규칙을
 * "{@code road_address}를 trim하고, trim한 {@code detail_address}가 비어 있지 않을 때만 한 칸을
 * 사이에 두어 결합"으로 고정했습니다. 그 규칙은 Service가 적용하고 이 계층은 완성된 값을
 * 저장만 합니다.</p>
 *
