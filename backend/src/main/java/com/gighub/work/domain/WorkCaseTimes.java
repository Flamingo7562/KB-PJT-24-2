 ...
 *
 * <p>종료 시각이 시작 시각보다 이르거나 같은 입력을 같은 날로 볼지 다음 날로 볼지는 아직
 * 결정되지 않았습니다. 이 클래스는 주어진 날짜와 시각을 결합하기만 하고 야간 근무 여부를
 * 판단하지 않습니다. 결합 결과가 유효한지는 호출부가 {@link #endsAfterStart}로 확인합니다.</p>
 */
